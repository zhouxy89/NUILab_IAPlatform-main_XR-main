    ...
    /// </summary>
        ...
        private void SetMaterials()
        {
            ...
            if (wireframeMaterial == null)
            {
                ...
                wireframeMaterial = new Material(LitShaderUtility.HDRPShader);
            ...
            if (handleMaterial == null)// && handleMaterial != wireframeMaterial)
            {
                ...
                handleMaterial = new Material(LitShaderUtility.HDRPShader);
            ...
            if (handleGrabbedMaterial == null)// && handleGrabbedMaterial != handleMaterial && handleGrabbedMaterial != wireframeMaterial)
            {
                ...
                handleGrabbedMaterial = new Material(LitShaderUtility.HDRPShader);
