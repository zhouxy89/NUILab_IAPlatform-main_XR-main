...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ControllerInput_example p_ControllerInput_example;
        ...
        public static SteamVR_Input_ActionSet_ControllerInput_example ControllerInput_example
        {
            get
            {
                return SteamVR_Actions.p_ControllerInput_example.GetCopy<SteamVR_Input_ActionSet_ControllerInput_example>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ControllerInput_example = ((SteamVR_Input_ActionSet_ControllerInput_example)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ControllerInput_example>("/actions/ControllerInput_example")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ControllerInput_example};
        }
    }
}
